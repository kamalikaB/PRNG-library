/********************The program generates numbers in binary form from a seed using xorshift64STAR**********************/
...
void main()
{
	...
	for(i=0;i<n;i++)
	{
		...
		/****************To convert to character use this**************************************/
	...
	//fprintf(fp,"%c",ch);//to print the last charceter if it is less than 8 bits
}
